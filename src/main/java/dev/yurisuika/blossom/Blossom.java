...
public class Blossom {
    ...
    public static class ClientModBusEvents {
        ...
        public static void clientSetup(FMLClientSetupEvent event) {
            ...
            ModelPredicateProviderRegistry.register(FLOWERING_OAK_LEAVES.get().asItem(), new Identifier("age"), (stack, world, entity) -> {
            ...
            ModelPredicateProviderRegistry.register(FRUITING_OAK_LEAVES.get().asItem(), new Identifier("age"), (stack, world, entity) -> {
                NbtCompound nbtCompound = stack.getSubTag("BlockStateTag");
                try {
                    if (nbtCompound != null && nbtCompound.get(FloweringLeavesBlock.AGE.getName()) != null) {
