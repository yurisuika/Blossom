...
public class Blossom {
    ...
    public static class ClientModBusEvents {
        ...
        public static void registerItemProperties(FMLClientSetupEvent event) {
            ItemProperties.register(BlossomItems.FRUITING_OAK_LEAVES.get(), ResourceLocation.tryParse("age"), (stack, world, entity) -> {
            ...
            ItemProperties.register(BlossomItems.FLOWERING_OAK_LEAVES.get(), ResourceLocation.tryParse("age"), (stack, world, entity) -> {
                CompoundTag tag = stack.getTagElement("BlockStateTag");
