...
public class Blossom implements ModInitializer, ClientModInitializer {
    ...
    public static void registerServerEntityEvents() {
        ServerEntityEvents.ENTITY_LOAD.register((entity, world) -> {
            if (entity instanceof BeeEntity) {
                ((MobEntityAccessor)entity).getGoalSelector().add(4, new BlossomGoal((BeeEntity)entity));
                ((MobEntityAccessor)entity).getGoalSelector().add(4, new FruitGoal((BeeEntity)entity));
            }
        });
    }
    ...
    public static void registerModelPredicateProviders() {
        FabricModelPredicateProviderRegistry.register(FLOWERING_OAK_LEAVES.asItem(), new Identifier("age"), (stack, world, entity) -> {
        ...
        FabricModelPredicateProviderRegistry.register(FRUITING_OAK_LEAVES.asItem(), new Identifier("age"), (stack, world, entity) -> {
            NbtCompound nbtCompound = stack.getSubTag("BlockStateTag");
            try {
