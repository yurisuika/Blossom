...
public class Blossom implements ModInitializer {
    ...
    public static void registerBlocks() {
        Registry.register(Registry.BLOCK, ResourceLocation.tryParse("blossom:flowering_oak_leaves"), BlossomBlocks.FLOWERING_OAK_LEAVES);
        Registry.register(Registry.BLOCK, ResourceLocation.tryParse("blossom:fruiting_oak_leaves"), BlossomBlocks.FRUITING_OAK_LEAVES);
    }

    public static void registerItems() {
        Registry.register(Registry.ITEM, ResourceLocation.tryParse("blossom:flowering_oak_leaves"), BlossomItems.FLOWERING_OAK_LEAVES);
        Registry.register(Registry.ITEM, ResourceLocation.tryParse("blossom:fruiting_oak_leaves"), BlossomItems.FRUITING_OAK_LEAVES);
    }

    public static void registerParticles() {
        Registry.register(Registry.PARTICLE_TYPE, ResourceLocation.tryParse("blossom:flowering_oak_leaves"), BlossomParticleTypes.FLOWERING_OAK_LEAVES);
    }
    ...
    public static class Client implements ClientModInitializer {
        ...
        public static void registerItemProperties() {
            FabricModelPredicateProviderRegistry.register(BlossomItems.FLOWERING_OAK_LEAVES, ResourceLocation.tryParse("age"), (stack, world, entity, seed) -> {
            ...
            FabricModelPredicateProviderRegistry.register(BlossomItems.FRUITING_OAK_LEAVES, ResourceLocation.tryParse("age"), (stack, world, entity, seed) -> {
                CompoundTag tag = stack.getTagElement("BlockStateTag");
