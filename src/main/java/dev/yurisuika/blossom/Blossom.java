...
public class Blossom implements ModInitializer, ClientModInitializer {
    ...
    public static void registerModelPredicateProviders() {
        FabricModelPredicateProviderRegistry.register(FLOWERING_OAK_LEAVES.asItem(), new Identifier("age"), (stack, world, entity, seed) -> {
        ...
        FabricModelPredicateProviderRegistry.register(FRUITING_OAK_LEAVES.asItem(), new Identifier("age"), (stack, world, entity, seed) -> {
            NbtCompound nbtCompound = stack.getSubNbt("BlockStateTag");
            try {
