...
public class Blossom {
    ...
    public static class ModEvents {
        ...
        public static void registerBlocks(RegisterEvent event) {
            event.register(ForgeRegistries.Keys.BLOCKS, helper -> helper.register(ResourceLocation.fromNamespaceAndPath("blossom", "flowering_oak_leaves"), BlossomBlocks.FLOWERING_OAK_LEAVES));
            event.register(ForgeRegistries.Keys.BLOCKS, helper -> helper.register(ResourceLocation.fromNamespaceAndPath("blossom", "fruiting_oak_leaves"), BlossomBlocks.FRUITING_OAK_LEAVES));
        }

        @SubscribeEvent
        public static void registerItems(RegisterEvent event) {
            event.register(ForgeRegistries.Keys.ITEMS, helper -> helper.register(ResourceLocation.fromNamespaceAndPath("blossom", "flowering_oak_leaves"), BlossomItems.FLOWERING_OAK_LEAVES));
            event.register(ForgeRegistries.Keys.ITEMS, helper -> helper.register(ResourceLocation.fromNamespaceAndPath("blossom", "fruiting_oak_leaves"), BlossomItems.FRUITING_OAK_LEAVES));
        }

        @SubscribeEvent
        public static void registerParticles(RegisterEvent event) {
            event.register(ForgeRegistries.Keys.PARTICLE_TYPES, helper -> helper.register(ResourceLocation.fromNamespaceAndPath("blossom", "flowering_oak_leaves"), BlossomParticleTypes.FLOWERING_OAK_LEAVES));
        }
        ...
        public static class ModEvents {
            ...
            public static void registerCreativeModeTabs(BuildCreativeModeTabContentsEvent event) {
                if (CreativeModeTabs.NATURAL_BLOCKS.equals(event.getTabKey())) {
                    event.accept(BlossomItems.FLOWERING_OAK_LEAVES);
                    event.accept(BlossomItems.FRUITING_OAK_LEAVES);
                }
            }
