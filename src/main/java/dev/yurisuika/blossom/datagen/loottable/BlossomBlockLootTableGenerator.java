...
public class BlossomBlockLootTableGenerator extends BlockLootTableGenerator {
    ...
    public BlossomBlockLootTableGenerator() {
        super(Set.of(), FeatureFlags.FEATURE_MANAGER.getFeatureSet());
    }

    @Override
    public void generate() {
        addDrop(Blossom.FLOWERING_OAK_LEAVES.get(), (Block block) -> blossomingOakLeavesDrops(block, Blocks.OAK_SAPLING, BlockStatePropertyLootCondition.builder(Blossom.FLOWERING_OAK_LEAVES.get()).properties(StatePredicate.Builder.create().exactMatch(FloweringLeavesBlock.AGE, 7)), 0.05F, 0.0625F, 0.083333336F, 0.1F));
