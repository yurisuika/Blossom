...
public class BlossomBlocks {
    ...
    public static void register() {
        Registry.register(Registry.BLOCK, ResourceLocation.tryParse("blossom:fruiting_oak_leaves"), FRUITING_OAK_LEAVES);
        Registry.register(Registry.BLOCK, ResourceLocation.tryParse("blossom:flowering_oak_leaves"), FLOWERING_OAK_LEAVES);
    }
