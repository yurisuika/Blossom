...
public class BlossomItems {
    ...
    public static void register() {
        Registry.register(BuiltInRegistries.ITEM, ResourceLocation.tryParse("blossom:fruiting_oak_leaves"), FRUITING_OAK_LEAVES);
        Registry.register(BuiltInRegistries.ITEM, ResourceLocation.tryParse("blossom:flowering_oak_leaves"), FLOWERING_OAK_LEAVES);
    }
