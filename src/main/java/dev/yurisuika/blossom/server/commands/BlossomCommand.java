                        ...
                        .then(Commands.literal("dimension")
                                ...
                                .then(Commands.literal("blacklist")
                                        ...
                                        .then(Commands.literal("remove")
                                                .then(Commands.argument("dimension", DimensionArgument.dimension())
                                                        .executes(commandContext -> {
                                                            String dimension = commandContext.getSource().registryAccess().registryOrThrow(Registry.DIMENSION_TYPE_REGISTRY).get(DimensionArgument.getDimension(commandContext, "dimension").dimension().location()).toString();
