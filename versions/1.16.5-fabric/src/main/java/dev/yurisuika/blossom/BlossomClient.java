...
public class BlossomClient implements ClientModInitializer {
    ...
    public static void registerItemProperties() {
        FabricModelPredicateProviderRegistry.register(BlossomItems.FLOWERING_APPLE_LEAVES, new ResourceLocation(Blossom.MOD_ID, "age"), (stack, world, entity) -> {
        ...
        FabricModelPredicateProviderRegistry.register(BlossomItems.FRUITING_APPLE_LEAVES, new ResourceLocation(Blossom.MOD_ID, "age"), (stack, world, entity) -> {
            CompoundTag tag = stack.getTagElement("BlockStateTag");
