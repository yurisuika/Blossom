        ...
        dispatcher.register(Commands.literal("blossom")
                ...
                .then(Commands.literal("filter")
                        ...
                        .then(Commands.literal("temperature")
                                .executes(commandContext -> {
                                    MutableComponent min = ComponentUtils.wrapInSquareBrackets(Component.translatable("commands.blossom.filter.temperature.min", Configure.getTemperatureMin())).withStyle(style -> style.withColor(ChatFormatting.GREEN).withHoverEvent(new HoverEvent.ShowText(Component.translatable("commands.blossom.filter.temperature.min.tooltip"))));
                                    MutableComponent max = ComponentUtils.wrapInSquareBrackets(Component.translatable("commands.blossom.filter.temperature.max", Configure.getTemperatureMax())).withStyle(style -> style.withColor(ChatFormatting.GREEN).withHoverEvent(new HoverEvent.ShowText(Component.translatable("commands.blossom.filter.temperature.max.tooltip"))));
                        ...
                        .then(Commands.literal("downfall")
                                .executes(commandContext -> {
                                    MutableComponent min = ComponentUtils.wrapInSquareBrackets(Component.translatable("commands.blossom.filter.downfall.min", Configure.getDownfallMin())).withStyle(style -> style.withColor(ChatFormatting.GREEN).withHoverEvent(new HoverEvent.ShowText(Component.translatable("commands.blossom.filter.downfall.min.tooltip"))));
                                    MutableComponent max = ComponentUtils.wrapInSquareBrackets(Component.translatable("commands.blossom.filter.downfall.max", Configure.getDownfallMax())).withStyle(style -> style.withColor(ChatFormatting.GREEN).withHoverEvent(new HoverEvent.ShowText(Component.translatable("commands.blossom.filter.downfall.max.tooltip"))));
                                    commandContext.getSource().sendSuccess(() -> Component.translatable("commands.blossom.filter.temperature.query", min, max), false);
                                    return 1;
                                })
