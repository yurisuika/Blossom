...
public class BlossomBlocks {
    ...
    public static final Block FRUITING_APPLE_LEAVES = new FruitingLeavesBlock(BlockBehaviour.Properties.of()
            ...
            .pushReaction(PushReaction.DESTROY)
            .isRedstoneConductor(Blocks::never));
    public static final Block APPLE_SIGN = new BlossomStandingSignBlock(BlossomWoodType.APPLE, BlockBehaviour.Properties.of()
            .mapColor(MapColor.WOOD)
            .forceSolidOn()
            .instrument(NoteBlockInstrument.BASS)
            .noCollission()
            .strength(1.0F)
            .ignitedByLava());
    public static final Block APPLE_WALL_SIGN = new BlossomWallSignBlock(BlossomWoodType.APPLE, BlockBehaviour.Properties.of()
            .mapColor(MapColor.WOOD)
            .forceSolidOn()
            .instrument(NoteBlockInstrument.BASS)
            .noCollission()
            .strength(1.0F)
            .ignitedByLava());
    public static final Block APPLE_HANGING_SIGN = new BlossomCeilingHangingSignBlock(BlossomWoodType.APPLE, BlockBehaviour.Properties.of()
            .mapColor(MapColor.WOOD)
            .forceSolidOn()
            .instrument(NoteBlockInstrument.BASS)
            .noCollission()
            .strength(1.0F)
            .ignitedByLava());
    public static final Block APPLE_WALL_HANGING_SIGN = new BlossomWallHangingSignBlock(BlossomWoodType.APPLE, BlockBehaviour.Properties.of()
            .mapColor(MapColor.WOOD)
            .forceSolidOn()
            .instrument(NoteBlockInstrument.BASS)
            .noCollission()
