...
public class Blossom {
    ...
    public static class ModEvents {
        ...
        public static void registerParticles(RegisterEvent event) {
            event.register(ForgeRegistries.Keys.PARTICLE_TYPES, helper -> helper.register(ResourceLocation.fromNamespaceAndPath("blossom", "flowering_apple_leaves"), BlossomParticleTypes.FLOWERING_APPLE_LEAVES));
        }
