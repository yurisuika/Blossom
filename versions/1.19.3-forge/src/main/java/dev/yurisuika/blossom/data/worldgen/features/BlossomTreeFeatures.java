...
public class BlossomTreeFeatures {
    ...
    public static final ResourceKey<ConfiguredFeature<?, ?>> APPLE = ResourceKey.create(Registries.CONFIGURED_FEATURE, ResourceLocation.tryParse("blossom:apple"));
    public static final ResourceKey<ConfiguredFeature<?, ?>> APPLE_BEES_0002 = ResourceKey.create(Registries.CONFIGURED_FEATURE, ResourceLocation.tryParse("blossom:apple_bees_0002"));
    public static final ResourceKey<ConfiguredFeature<?, ?>> APPLE_BEES_002 = ResourceKey.create(Registries.CONFIGURED_FEATURE, ResourceLocation.tryParse("blossom:apple_bees_002"));
    public static final ResourceKey<ConfiguredFeature<?, ?>> APPLE_BEES_005 = ResourceKey.create(Registries.CONFIGURED_FEATURE, ResourceLocation.tryParse("blossom:apple_bees_005"));
